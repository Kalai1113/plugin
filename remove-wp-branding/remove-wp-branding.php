...
Plugin Name: Simplia
Plugin URI: 
Description: Replace and Remove the WordPress branding from the login page and the admin dashboard. Replace existing logos and text with your own.
Version: 1.0.0
Author: Kalai developer
Author URI: 
License:  later
*/
...
function rwp_initial_install() {
  ...
  add_option( 'rwp_lower_left_text', 'Plugins by <a href="https://simplia.com/>simplia.com</a>' );
  ...
  if ( !current_user_can( 'manage_options' ) )  {
    ...
    <div class="wrap">
      <div style="float:right;margin-left:10px;text-align:right;">
        Plugins by <a href="https://simplia.com/" target="_blank">simplia</a><br>
